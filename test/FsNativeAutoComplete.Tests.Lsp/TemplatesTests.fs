module FsNativeAutoComplete.Tests.Templates
...
let tests () =
  ...
  <| testList
    ...
    [ testCase "Templates are not empty"
      <| fun () ->
           FsNativeAutoComplete.DotnetNewTemplate.installedTemplates ()
           |> Expect.isNonEmpty
           <| "Templates are empty"
      ...
      <| fun () ->
           FsNativeAutoComplete.DotnetNewTemplate.templateDetails ()
           |> Expect.isNonEmpty
