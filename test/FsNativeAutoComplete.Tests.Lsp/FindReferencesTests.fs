module FsNativeAutoComplete.Tests.FindReferences
...
open FSharp.UMX
open FsNativeAutoComplete.LspHelpers.Conversions
        ...
        async {
          if not scriptFilesLoaded then
            ...
            for file in files do
              ...
              // see https://github.com/fsharp/FsNativeAutoComplete/pull/1037#issuecomment-1440016138
