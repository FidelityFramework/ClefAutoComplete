module FsNativeAutoComplete.Tests.Lsp.CoreUtilsTests
...
/// Tests for the core utility functions in FsNativeAutoComplete.Utils module
module UtilsTests =
  ...
  let allTests = testList "FsNativeAutoComplete.Utils Tests" [
    fileTypeTests
    pathTests  
    stringTests
    mapTests
