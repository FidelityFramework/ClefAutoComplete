...
/// ])
/// ```
val serverTestList: (string -> (unit -> FsNativeAutoComplete.Lsp.IFSharpLspServer * System.IObservable<string * obj>) -> FsNativeAutoComplete.LspHelpers.FSharpConfigDto -> option<string> -> (Async<Server> -> list<Test>) -> Test)
val fserverTestList: (string -> (unit -> FsNativeAutoComplete.Lsp.IFSharpLspServer * System.IObservable<string * obj>) -> FsNativeAutoComplete.LspHelpers.FSharpConfigDto -> option<string> -> (Async<Server> -> list<Test>) -> Test)
val pserverTestList: (string -> (unit -> FsNativeAutoComplete.Lsp.IFSharpLspServer * System.IObservable<string * obj>) -> FsNativeAutoComplete.LspHelpers.FSharpConfigDto -> option<string> -> (Async<Server> -> list<Test>) -> Test)
