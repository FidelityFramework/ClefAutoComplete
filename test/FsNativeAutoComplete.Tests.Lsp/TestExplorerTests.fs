module FsNativeAutoComplete.Tests.TestExplorer
...
open FsNativeAutoComplete.Tests.Lsp.Helpers
...
module TestRunResult =
  ...
  let tryUnwrapTestRunResult (res: LspResult<PlainNotification option>) =
    ...
    | Ok plainNotification ->
      ...
      |> Option.get
      |> _.Content
      |> FsNativeAutoComplete.JsonSerializer.readJson<
        FsNativeAutoComplete.CommandResponse.ResponseMsg<FsNativeAutoComplete.TestServer.TestResult list>
          >
      |> _.Data
...
module TestDiscoveryResult =
  ...
  let tryUnwrapTestDiscoveryResult (res: LspResult<PlainNotification option>) =
    ...
    | Ok plainNotification ->
      ...
      |> _.Content
      |> FsNativeAutoComplete.JsonSerializer.readJson<
        FsNativeAutoComplete.CommandResponse.ResponseMsg<FsNativeAutoComplete.TestServer.TestItem list>
          >
      |> _.Data
...
module ExpectedTests =
  let VSTestXUnitRunResults =
    [ "Tests.My test", FsNativeAutoComplete.TestServer.TestOutcome.Passed
      "Tests.Fails", FsNativeAutoComplete.TestServer.TestOutcome.Failed
      "Tests.Skipped", FsNativeAutoComplete.TestServer.TestOutcome.Skipped
      "Tests.Exception", FsNativeAutoComplete.TestServer.TestOutcome.Failed
      "Tests+Nested.Test 1", FsNativeAutoComplete.TestServer.TestOutcome.Passed
      "Tests+Nested.Test 2", FsNativeAutoComplete.TestServer.TestOutcome.Passed
      "Tests.Expects environment variable", FsNativeAutoComplete.TestServer.TestOutcome.Failed ]
      ...
      testList
        ...
        [ testCaseAsync "it should report tests of all basic outcomes"
          ...
          <| async {
            ...
            let expected =
              [ "Tests.Expects environment variable", FsNativeAutoComplete.TestServer.TestOutcome.Passed ]
